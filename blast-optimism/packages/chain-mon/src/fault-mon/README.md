...
The state root of the block is published to the [`L2OutputOracle`](https://github.com/tenderly/net-blast/blast-optimism/blob/39b7262cc3ffd78cd314341b8512b2683c1d9af7/packages/contracts-bedrock/contracts/L1/L2OutputOracle.sol) contract on Ethereum.
