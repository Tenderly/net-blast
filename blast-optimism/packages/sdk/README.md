...
The [`CrossChainMessenger`](https://github.com/tenderly/net-blast/blast-optimism/blob/develop/packages/sdk/src/cross-chain-messenger.ts) class simplifies the process of moving assets and data between Ethereum and Optimism.
...
The Optimism SDK includes [various utilities](https://github.com/tenderly/net-blast/blast-optimism/blob/develop/packages/sdk/src/l2-provider.ts) for handling Optimism's [transaction fee model](https://community.optimism.io/docs/developers/build/transaction-fees/).
