...
export class CrossChainMessenger {
  ...
  //     https://github.com/tenderly/net-blast/blast-optimism/issues/2129
  //   `)
  // }
  ...
  public async getMessageProof(
    ...
    // https://github.com/tenderly/net-blast/blast-optimism/blob/c84d3450225306abbb39b4e7d6d82424341df2be/packages/contracts/contracts/L2/predeploys/OVM_L2ToL1MessagePasser.sol#L23
